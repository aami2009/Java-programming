...
public class ForkJoin1 {
	...
	private static void fileHandeling(){
		  //Create ForkJoinPool using the default constructor.
	      ForkJoinPool pool = new ForkJoinPool(3);
	     //Create three FolderProcessor tasks. Initialize each one with a different folder path.
	      FolderProcessor system = new FolderProcessor("C:\\text", "txt");
	      FolderProcessor apps = new FolderProcessor("C:\\text", "txt");
...
class Sum3 extends RecursiveAction{
	...
	private void add(){
		sum = var1 + var2; 
		//System.out.println("Recursive Action: It will not return anything "+sum);
	}
